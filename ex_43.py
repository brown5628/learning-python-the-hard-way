    ...
    def enter(self):
        ...
        if action == "shoot!":
            print(dedent("""
                ...
                Your laser hits his costume but misses him enitely.
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            the room and find the neutron bomb in ints container.
            There's a keypad lock on the box and you need the code to get the bomb out.
            If you get the code wrong 10 times then the lock closed forever and
        ...
        if guess == code:
            print(dedent("""
                    ...
                    you can to the bridge where you must place it in the right
                    spot.
                    """))
            return 'the_bridge'
        else:
